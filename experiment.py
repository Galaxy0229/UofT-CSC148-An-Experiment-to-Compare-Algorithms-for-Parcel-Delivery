...
class SchedulingExperiment:
    ...
    _stats:
      ...
      values as specified in Step 5 of Assignment 1.
    _unscheduled:
    ...
    def run(self, report: bool = False) -> Dict[str, Union[int, float]]:
        ...
        """
        self._unscheduled = self.scheduler.schedule(
            self.parcels, self.fleet.trucks, self.verbose)
        self._compute_stats()
        if report:
            self._print_report()
        return self._stats
    ...
    def _compute_stats(self) -> None:
        ...
        <self>.stats. Keys and values are as specified in Step 5 of
        Assignment 1.
        ...
        self._stats = {
            ...
            'unused_trucks':
                self.fleet.num_trucks() - self.fleet.num_nonempty_trucks(),
    ...
    def _print_report(self) -> None:
        ...
        """
        print(self._stats, 'print the report')
...
def read_distance_map(distance_map_file: str) -> DistanceMap:
    ...
    with open(distance_map_file, 'r') as file:
        for line in file:
            ...
            dmp.add_distance(c1, c2, distance1, distance2)
    return dmp
